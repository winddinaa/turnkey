...
import { setDepartmentModal } from "../../../reduxs/department/departmentSlice";

const Header = () => {
  const dispatch = useDispatch();
  return (
    <div className="w-[100%]">
      <TextComponent variant="h3">Department</TextComponent>
      <div
        className="flex 
     w-[100%] justify-between items-center"
      >
        <div className="py-5 w-[50%]">
          <InputComponent label="Search Department" icon={<SearchIcon />} />
        </div>
        <div>
          <ButtonComponent
